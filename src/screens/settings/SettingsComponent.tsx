        ...
        <TouchableOpacity
            ...
            <View style={styles.rowContainer}>
                ...
                <View style={styles.textContainer}>
                    ...
                    {subtitle ? <Text style={[appStyles.caption, { color: colors.textSecondary }]}>{subtitle}</Text> : null}
                </View>
    ...
    return (
        <TouchableOpacity onPress={onPress} style={styles.rowTouchContainer}>
            <View style={styles.rowItemContainer}>
                <Icon name={icon} size={18} color={colors.white} style={{ backgroundColor: iconBackground, borderRadius: 100, padding: 8 }} />
                <Text style={[appStyles.bodyText, { color: colors.textPrimary, flex: 1, marginLeft: 10 }]}>{title}</Text>
                <Icon name="chevron-forward" size={18} color={colors.divider} />
            </View>
        </TouchableOpacity>
    );
